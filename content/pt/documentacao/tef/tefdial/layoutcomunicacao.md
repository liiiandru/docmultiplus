...
| Código do Campo | Tipo de Informação                                | ATV | ADM | CRT   | CNC   | REL |
|-----------------|---------------------------------------------------|-----|-----|-------|-------|-----|
